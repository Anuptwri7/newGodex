...
public final class LoginBinding implements ViewBinding {
  ...
  private LoginBinding(@NonNull LinearLayout rootView, @NonNull EditText email,
      @NonNull Button loginButton, @NonNull EditText password, @NonNull ProgressBar progressBar,
  ...
  public static LoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LoginBinding((LinearLayout) rootView, email, loginButton, password, progressBar,
          textView4);
    }
