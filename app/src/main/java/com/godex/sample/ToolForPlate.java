...
public class ToolForPlate extends FrontPlateActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        printPDFButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(ToolForPlate.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Handler handler = new Handler(msg -> {
                        ...
                        if (s!=null && !s.isEmpty()) {
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(ToolForPlate.this);
                    ...
                    if (fileToSend == null) {
                        Toast.makeText(ToolForPlate.this, "請選擇檔案", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    Loading loading = new Loading(ToolForPlate.this);
                    loading.showDialog();
